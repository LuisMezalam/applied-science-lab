...
const initialConcepts: KnowledgeConcept[] = [
  ...
  },
  {
    ...
    equations: [
      ...
      'Iₓₓ = ∬(y-ȳ)²·I dA (about centroidal x-axis)',
      'Iᵧᵧ = ∬(x-x̄)²·I dA (about centroidal y-axis)',
      'Iₓᵧ = ∬(x-x̄)(y-ȳ)·I dA (product of inertia)',
    ],
    sourceDocument: 'General_Translation_Template_For_All_Work_disciplines_wrt_loading_2.pdf',
  },
  {
  ...
  },
  {
    ...
    category: 'example',
    domain: 'unified',
    content: 'Closed-form centroid and second moment formulas for common shapes with uniform intensity I₀ = ∫I dA. The second moments below are about centroidal axes.',
    equations: [
      'Rectangle (L×H centered): x̄ = 0, ȳ = 0',
      '  Iₓₓ = I₀·H²/12, Iᵧᵧ = I₀·L²/12',
      'Triangle (base b, height h): x̄ = 0, ȳ = h/3',
      '  Iₓₓ = I₀·h²/18, Iᵧᵧ = I₀·b²/24',
      'Circle (radius R): x̄ = ȳ = 0',
      '  Iₓₓ = Iᵧᵧ = I₀·R²/4, J = I₀·R²/2 (polar)',
      'Semicircle: ȳ = 4R/(3π) from diameter base',
    ],
    sourceDocument: 'General_Translation_Template_For_All_Work_disciplines_wrt_loading_2.pdf',
  },
];
